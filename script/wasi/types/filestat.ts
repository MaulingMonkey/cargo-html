namespace wasi {
     ...
     */
    export type Device = u64 & { _not_real: "device" };
    ...
    export type Inode = u64 & { _not_real: "inode" };
    ...
    export function write_filestat(memory: MemoryLE, ptr: ptr, off: number, filestat: FileStat) {
