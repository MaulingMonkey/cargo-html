namespace wasi {
    ...
    export type PreOpenType = u8 & { _not_real: "preopentype"; }



    /** A pre-opened directory. */
    export const PREOPENTYPE_DIR = <PreOpenType>0;
    ...
    export function write_prestat(memory: MemoryLE, ptr: ptr, off: usize, prestat: PreStat) {
